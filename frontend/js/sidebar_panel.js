...
function loadSidebarMenu() {
    ...
    const menus = {
        admin: [
            { icon: '🏠', text: 'Inicio', action: 'goToHome', active: true, emoji: true },
            { icon: '📋', text: 'Asignación', action: 'showAssignmentSection', emoji: true },
            { icon: '📝', text: 'Asignaciones', action: 'showAssignmentsSection', emoji: true },
            { icon: '👨‍🏫', text: 'Panel del tutor', action: 'showTutorPanel', emoji: true },
            { icon: '📅', text: 'Sesiones', action: 'showSessionsSection', emoji: true },
            { icon: '🚪', text: 'Cerrar sesión', action: 'logout', emoji: true, danger: true }
        ],
        tutor: [
            ...
            { icon: 'M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1', text: 'Cerrar Sesión', action: 'logout', danger: true }
        ],
        student: [
            { icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', text: 'Panel Principal', action: 'goToHome', active: true },
    ...
    menuItems.forEach((item, index) => {
        ...
        if (item.emoji) {
            // Menú con emojis (estilo imagen)
            menuHTML += `
                <li>
                    <a href="#" class="${activeClass} ${dangerClass}" onclick="handleMenuAction('${item.action}'); return false;">
